	...
	factory: (require) => {
		...
		*/
		function SubagentMonitorPanel(props) {
			...
			*/
			...
			const collapsible = variant === "left" && onCollapse !== void 0;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: `sav-panel${variant === "tab" ? " sav-panel-tab" : ""}`,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function SubagentViewBarPanel(props) {
			...
			if (!wide) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					}), railRunning > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "sav-rail-badge",
						children: railRunning
					}) : null]
				});
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "sav-root",
				children: [monitor.open ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SubagentMonitorPanel, {
					variant: "left",
					useSessions,
					onCollapse: () => commit$1({ open: false })
				}) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					className: "sav-bar",
					type: "button",
					title: "Subagent runs",
					onClick: () => commit$1({ open: !monitor.open }),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MonitorStats, { rows: barVisible })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		function SubagentRightbarTab({ sessionId, useSessions }) {
			...
			useMonitorPolling();
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SubagentMonitorPanel, {
				variant: "tab",
				useSessions
			});
		}
